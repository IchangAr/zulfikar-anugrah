...
const ProfileCardComponent = ({
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group" style={{ width: '100%', height: '100%' }}>
        <section
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      <div className="text-sm font-medium text-white/90 leading-none" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}>@{handle}</div>
                      <div className="text-sm text-white/70 leading-none" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}>{status}</div>
                    </div>
                  </div>
                  <button
